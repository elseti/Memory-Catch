...
export default function GameOver( props:GameOverProps ){
    ...
    return(
        <div className="py-64 overflow-hidden items-center justify-center text-center absolute z-40 flex flex-col p-5 bg-gradient-to-b from-blue-300 to-blue-600 rounded-xl shadow-xl w-3/4 h-1/2 left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 md:w-1/2"> 
