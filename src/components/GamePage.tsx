    ...
    return(
        <div className="bg-cover bg-no-repeat flex flex-col w-full min-h-screen overflow-hidden gap-6 lg:gap-12" style={{ backgroundImage: `url(${props.backgroundPath})` }}>
            ...
            <div className="mx-8 justify-center text-center flex flex-col items-center">
                ...
                <button className="w-full my-6 md:my-16 md:text-3xl animate-pulse bg-gradient-to-t from-blue-800 to-blue-600 hover:bg-blue-400 p-4 text-white rounded-xl text-2xl tracking-wider shadow-lg md:w-1/2" onClick={props.onStart} >
                    Start!
                </button>
            </div>
